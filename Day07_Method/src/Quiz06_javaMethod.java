public class Quiz06_javaMethod {
	...
	// contains -> 문자열이 포함하고 있는지 여부를 리턴
	// replace() -> 특정 문자열을 찾아 다른 문자열로 바꾸는 메서드
	// java.replace('String1', 'String2') -> java에서 String1을 찾아 String2로 바꾸어준다
	public static int findJava(String java) {

		int count = 0;
		java = java.replace("Java", "0");
	...
	public static void main(String[] args) {
		...
		System.out.println("Java는 총 " + rsJava + "개");
	}
}